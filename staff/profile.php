...
// Access control
$user_id = $_SESSION['multi_user_sessions']['staff']['user_id'] ?? null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update user details
    if (!empty($password)) {
        $hashedPassword = $password; // You can hash the password here if needed
        // $hashedPassword = password_hash($password, PASSWORD_DEFAULT); // Uncomment if you want to hash the password
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Manage User Profile</h1>
                        <ol class="breadcrumb">
